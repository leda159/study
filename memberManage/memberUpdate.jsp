...
<body>
	...
	<%
	    ...
	    if(rs.next()){ //한사람의 정보만 가져오기때문에 if문으로 진행한다
	%>
	
	
	<div class="container">
		<form name="newProduct" action="./memberUpdate_process.jsp" class="form-horizontal" 
		      method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="name" name="name" class="form-control" value="<%=rs.getString("passwd")%>">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="birthday" name="birthday" class="form-control" value="<%=rs.getString("birthday")%>">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input id="postCd"
					       ...
					       readonly="readonly"
					       class="col-sm-2" 
						   type="text" class="form-control" value="<%=rs.getString("postCd")%>">
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
					<input id="addr" name="addr" type="text" class="form-control" value="<%=rs.getString("addr")%>" readonly="readonly"/>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
					<input id="addr2" 
					       name="addr2" 
					       type="text" class="form-control" value="<%=rs.getString("addr2")%>"/>
				</div>
			</div>					
